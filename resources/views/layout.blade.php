...
<html lang="en">
   ...
   <body class="game_info" data-spy="scroll" data-target=".header">
      <!-- LOADER -->
      <div id="preloader">
         <img class="preloader" src="/front/images/loading-img.gif" alt="">
      </div>
      <!-- END LOADER -->
      <section id="top">
         <header>
               ...
               <div class="header-top">
                  <div class="row">
                     <div class="col-md-6">
                        <div class="full">
                           <div class="logo">
                              <a href="{{ URL::to('/main') }}"><img src="/front/images/logo.png" alt="#" /></a>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <div class="right_top_section">
                           ...
                           <ul class="login">
                              <li class="login-modal">
                                 <a href="/logout" class="login"><i class="fa fa-user"></i>Login</a>
                              </li>
                              <li>
                                 <div class="cart-option">
                                    <a href="{{url('/reg/save')}}"><i class="fa fa-shopping-cart"></i>Register</a>
                                 </div>
                              </li>
                           </ul>
                           <!-- end button section -->
                                 ...
                                 <nav class="navbar navbar-inverse">
                                    ...
                                    <div class="collapse navbar-collapse js-navbar-collapse">
                                       <ul class="nav navbar-nav">
                                          <li class="active"><a href="{{ URL::to('/main') }}">Home</a></li>
                                          <li><a href="{{ URL::to('/about') }}">About</a></li>
                                          <li><a href="{{ URL::to('/event') }}">Event</a></li>
                                          <li><a href="{{ URL::to('/news') }}">News</a></li>
                                           <li><a href="{{ URL::to('/match') }}">Match Fixture</a></li>
                                          <li><a href="{{ URL::to('/point_table') }}">Points Table</a></li>
                                          <li><a href="{{ URL::to('/contact') }}">contact</a></li>
                                          <li><a href="{{ URL::to('/payment') }}">Payment Method</a></li>
                                       </ul>
                                    </div>
                                    <!-- /.nav-collapse -->
                                 </nav>
                  ...
                  <div class="full">
                     <div class="footer-widget">
                        <div class="footer-logo">
                           <a href="#"><img src="/front/images/footer-logo.png" alt="#" /></a>
                        </div>
                  ...
                  <div class="full">
                     <div class="footer-widget">
                        ...
                        <ul class="address-list">
                           <li><i class="fa fa-map-marker"></i> SUST CAMPUS..</li>
                           <li><i class="fa fa-phone"></i> +8801636880744</li>
                           <li><i style="font-size:20px;top:5px;" class="fa fa-envelope"></i> mobin@gmail.com</li>
                        </ul>
                     </div>
                  </div>
               </div>
               <div class="col-md-3">
                  <div class="full">
                     <div class="contact-footer">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d871.0468034046086!2d91.83129731526142!3d24.91722456774643!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3750556002144eab%3A0xe277e14dbca9f2ab!2sShahjalal+University+of+Science+and+Technology!5e1!3m2!1sen!2sbd!4v1562445465220!5m2!1sen!2sbd" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
                     </div>
                  </div>
               </div>
            </div>
