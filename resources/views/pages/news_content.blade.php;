         ...
         <div class="container">
            <div class="row">
                  ...
                  <div class="news-post-holder">
                     <div class="col-lg-6 col-sm-6 col-xs-12">
                        <div class="news-post-widget">
                           <img class="img-responsive" src="/front/images/img-01_002.jpg" alt="">
               ...
               <div class="col-lg-3 col-sm-6 col-xs-12">
                  <div class="content-widget top-story" style="background: url(/front/images/top-story-bg.jpg);">
                  ...
                  <aside id="sidebar" class="right-bar">
                     <div class="banner">
                        <img class="img-responsive" src="/front/images/adds-3.jpg" alt="#">
                     </div>
                  </aside>
               </div>
            </div>
