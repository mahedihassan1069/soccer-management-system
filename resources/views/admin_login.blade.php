					...
					<form class="form-horizontal" action="{{url('/admin-dashbord')}}" method="post">
						...
						<fieldset>
							...
							<div class="input-prepend" title="Admin_email">
								...
								<input class="input-large span10" name="admin_email"  type="text" placeholder="type email addrese"/>
							</div>
							...
							<div class="button-login">	
								<a href="{{url('/reg/save')}}" type="submit" class="btn btn-primary">Register</a>
							</div>
							<div class="clearfix"></div>
