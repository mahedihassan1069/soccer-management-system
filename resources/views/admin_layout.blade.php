					...
					<ul class="nav pull-right">
						...
						<li class="dropdown hidden-phone">
							...
							<ul class="dropdown-menu messages">
                            	...
                            	<li>
                                    <a href="#">
										<span class="avatar"><img src="/back/img/avatar.jpg" alt="Avatar"></span>
										<span class="header">
											<span class="from">
										    	Łukasz Holeczek
										     </span>
                                ...
                                <li>
                                    <a href="#">
										<span class="avatar"><img src="/back/img/avatar2.jpg" alt="Avatar"></span>
										<span class="header">
											<span class="from">
										    	Megan Abott
										     </span>
                                ...
                                <li>
                                    <a href="#">
										<span class="avatar"><img src="/back/img/avatar3.jpg" alt="Avatar"></span>
										<span class="header">
											<span class="from">
										    	Kate Ross
										     </span>
								...
								<li>
                                    <a href="#">
										<span class="avatar"><img src="/back/img/avatar4.jpg" alt="Avatar"></span>
										<span class="header">
											<span class="from">
										    	Julie Blank
										     </span>
                                ...
                                <li>
                                    <a href="#">
										<span class="avatar"><img src="/back/img/avatar5.jpg" alt="Avatar"></span>
										<span class="header">
											<span class="from">
										    	Jane Sanders
										     </span>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{URL::to('/all-event')}}"><i class="icon-envelope"></i><span class="hidden-tablet"> All Tournaments</span></a></li>

						<li><a href="{{URL::to('/add-event')}}"><i class="icon-envelope"></i><span class="hidden-tablet"> Add Tournaments</span></a></li>

						<li><a href="tasks.html"><i class="icon-tasks"></i><span class="hidden-tablet"> Add News</span></a></li>

						<li><a href="ui.html"><i class="icon-eye-open"></i><span class="hidden-tablet"> Add Matsh Fixture</span></a></li>
						<li><a href="widgets.html"><i class="icon-dashboard"></i><span class="hidden-tablet"> Add points</span></a></li>
						<li>
							<a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet">All Team </span><span class="label label-important">  </span></a>
							<!--<ul>
						...
						<li><a href="form.html"><i class="icon-edit"></i><span class="hidden-tablet"> Contact Uaser</span></a></li>
						<li><a href="chart.html"><i class="icon-list-alt"></i><span class="hidden-tablet"> Next Match</span></a></li>
						<li><a href="typography.html"><i class="icon-font"></i><span class="hidden-tablet"> Social Link</span></a></li>
